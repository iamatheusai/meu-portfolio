...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Matheus · Desenvolvedor Web Premium" },
      { name: "description", content: "Sites e landing pages que transformam autoridade em resultados. Design premium, performance máxima, conversão real." },
